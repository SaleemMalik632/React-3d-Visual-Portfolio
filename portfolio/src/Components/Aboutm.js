    ...
    return (
        <>
                <div className='about-catainer'>
                    ...
                    <div>
                        <Button variant="contained" size="large" style={{ backgroundColor: 'green', color: 'white' }}>GET RESUME</Button>
                        <Button variant="outlined" size="large" style={{ marginLeft: '10px', border: '2px solid green', color: 'white' }} >ABOUT ME</Button>
                    </div>
                </div>
                {/* <div>
